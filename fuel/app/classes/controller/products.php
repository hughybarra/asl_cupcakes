...
class Controller_Products extends Controller_Template {
	...
	public function action_create() {
		if (Input::method() == 'POST') {
			...
			if ($val -> run()) {
				$product = Model_Product::forge(array('name' => Input::post('name'), 'product_type' => Input::post('product_type'), 'product_description' => Input::post('product_description'), 'price' => Input::post('price'), 'image_path' => Input::post('image_path'), 'quantity' => Input::post('quantity'), 'product_reviews' => Input::post('product_reviews'), 'product_likes' => Input::post('product_likes'), ));
